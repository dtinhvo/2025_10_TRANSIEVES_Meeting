...
![Coupling Algorithm ^[F. Pimenta and M. A. Alves, “Numerical simulation of electrically-driven flows using OpenFOAM.” arXiv, 2018. doi: 10.48550/ARXIV.1802.02843.]](_Medias/algo.svg){height="9in" style="text-align:center"}
...
$$
    \left[ \nabla c_{i} \right]_{f}  \cdot n_{\perp} \mathbf{A}_{_{f}}    
    =   
    - \left[ \frac{\mu_{i}}{D_{i}}\left( \nabla \Psi \right)c_{i} \right]_{f} \cdot \mathbf{A}_{_{f}}
$$

$$
    \longrightarrow \nabla c_{i,f} + \frac{\mu_{i}}{D_{i}}\left( \nabla \Psi_{f} \right)c_{i,f} = 0 
$$
:::

::: {.fragment}

- Subgrid Zero Ionic Flux ^[F. Pimenta and M. A. Alves, “Numerical simulation of electrically-driven flows using OpenFOAM.” arXiv, 2018. doi: 10.48550/ARXIV.1802.02843.]  
    Dirichtlet-type
